...
// Home Hub — "The Treehouse Community" 3-audience value grid (Arc 2;
// docs/home-hub-design.md D9 + D10). Casts the full 3-sided platform vision:
// Treasure Seekers (green), Booth Vendors (gold), Shop Owners (teal).
// Informational pitch copy — NOT tappable (the actionable CTAs live elsewhere
// on the hub).
// Session 207 — David: "Treehouse Advantage" → "Treehouse Community"; section
// labels For Shoppers → Treasure Seekers, For Vendors → Booth Vendors, Malls →
// Shop Owners; COMING SOON tag dropped from Shop Owners; shopper icon →
// MdOutlineExplore (the Explore nav glyph), Shop Owners icon → PiTreeBold.

"use client";

import type { ReactNode } from "react";
import { PiStorefrontBold, PiTreeBold } from "react-icons/pi";
...
const AUDIENCES: Audience[] = [
  {
    icon: <MdOutlineExplore />, accent: v2.accent.green, labelColor: v2.accent.green, label: "TREASURE SEEKERS",
    copy: "Find unique pieces near you, save your favorites & never miss a great find.",
  },
  {
    icon: <PiStorefrontBold />, accent: HUB_GOLD, labelColor: HUB_GOLD_TEXT, label: "BOOTH VENDORS",
