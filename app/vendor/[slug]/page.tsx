          ...
          {hasImg ? (
            <div style={{ position: "relative", width: "100%", paddingBottom: "75%" }}>
              ...
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "0 9px 8px" }}>
                <div style={{ fontFamily: "Georgia, serif", fontSize: 13, fontWeight: 600, color: "#f5f0e8", lineHeight: 1.25, textShadow: "0 1px 8px rgba(5,13,5,0.9)", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" } as React.CSSProperties}>
                  {post.title}
                </div>
              </div>
            </div>
            ...
            <div style={{ padding: "12px 10px" }}>
              <div style={{ fontFamily: "Georgia, serif", fontSize: 13, fontWeight: 600, color: "#f5f0e8", lineHeight: 1.3 }}>{post.title}</div>
            </div>
          )}
        </div>
      </Link>
  ...
  if (notFound) {
    return (
      <div style={{ minHeight: "100vh", background: "#050f05", maxWidth: 430, margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
        <div style={{ fontFamily: "Georgia, serif", fontSize: 18, color: "#c8b47e" }}>Vendor not found.</div>
