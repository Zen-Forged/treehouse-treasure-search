...
//
// Session 194 Ask #2 — VisitorTrackerMount is a tiny "use client" wrapper
// that calls initVisitorTracker() once on app boot. Mounts inside body so
// the tracker fires across every surface (shopper + vendor + admin).
