// app/page.tsx
// Home screen — entry point for all flows.
// Camera and gallery both route to /discover, which is the decision hub
// for both the valuation flow ("What's it worth?") and story flow ("Tell the story").
"use client";
...
export default function HomePage() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen max-w-[430px] mx-auto overflow-hidden bg-[#050f05]">
      ...
      <input ref={galleryInputRef} type="file" accept="image/*" className="hidden" onChange={onGalleryChange} />
      ...
      <div className="relative z-10 flex flex-col flex-1 px-6" style={{ paddingBottom: "max(36px, env(safe-area-inset-bottom, 36px))" }}>
        ...
        {/* Logo */}
        <motion.div className="flex items-center gap-2.5 pt-14"
          initial={{ opacity: 0 }} animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.05 }}>
          <Image src="/logo.png" alt="Treehouse Search" width={26} height={26}
        ...
        <motion.div className="pb-7"
          ...
          <h1 style={{ fontFamily: "Georgia, serif", fontSize: 40, fontWeight: 700, color: "#f5f0e8", lineHeight: 1.1, letterSpacing: "-0.8px" }}>
            ...
            <span style={{ display: "block", fontStyle: "italic", color: "#c8b47e", fontWeight: 600, fontSize: 34 }}>
        ...
        <motion.div className="flex flex-col gap-3"
          ...
          <motion.button
            ...
            style={{
              ...
              border: "1px solid rgba(109,188,109,0.16)", borderBottom: "1px solid rgba(15,45,15,0.7)",
          ...
          {/* Tag line */}
          <div className="flex items-center justify-center gap-3 mt-3 pt-4"
