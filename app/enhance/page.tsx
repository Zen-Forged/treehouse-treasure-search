...
export default function EnhancePage() {
  ...
  const handleSkip = () => {
    setDraft({ imageEnhanced: undefined });
    router.push("/story");
  };
    ...
    <div className="flex flex-col min-h-screen bg-[#050f05]">
      ...
      >
        ...
        <span style={{
          ...
          fontSize: 15, color: "#d4c9b0", marginLeft: 14
        }}>
      ...
      <main className="flex-1 flex flex-col px-5 py-5 gap-4">
        ...
        {processing ? (
          ...
          <>
            ...
            >
              <span style={{ fontSize: 9, color: "#6a5528", textTransform: "uppercase", letterSpacing: "2.5px" }}>
                As found
              </span>
            ...
            >
              Cameras don't always capture what you see.<br />
