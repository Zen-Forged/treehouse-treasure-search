...
- **Tech Rule promotion batch** (~40 min) — **fifteen candidates queued**. Three promotion-ready: email-template-parity-audit (2nd firing session 52), script-first-over-SQL-dump (2nd firing session 48), and **NEW session-56 commit-design-records-in-same-session** (2nd firing, promotion-ready). Plus session-52 Gmail-hostile primitives list (1st firing) and session-54's three first-firing candidates.
